...
import id.web.prayitno.projek2moviedicoding.service.StackWidgetService;
...
public class MovieAppWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "id.web.prayitno.projek2moviedicoding.TOAST_ACTION";
    public static final String EXTRA_ITEM = "id.web.prayitno.projek2moviedicoding.EXTRA_ITEM";
